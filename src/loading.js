var LoadingInit = function(){
	...
	this.app.client.loader.asyncLoadImage('../../library/objects'+data[i],'../../library/objects'+data[i]).then(function(st){

		self.datacount++;
		self['sprite'+self.datacount] = st;

		console.log('sprite'+self.datacount);
...
var LoadingScreen = {
	...
	draw:function(){
		...
		if (this.timetostart==2) {
					return;
			this.app.mapper.app = (this.app);
			this.app.mapper.graphics = (this.app.client.graphics);
			this.app.mapper.visuals = (this.app.client.visuals);
			this.app.mapper.loader = this;
			this.app.client.update.state = this.app.mapper;
